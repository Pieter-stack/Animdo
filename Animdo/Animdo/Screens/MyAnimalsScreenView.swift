                                    ...
                                    if animal.adoper == "hello"{
                                        if animal.species == filterSearch{
                                            NavigationLink(destination: MyAnimalsPurchaseFail(animal: animal).navigationBarBackButtonHidden(true), label: {
                                                MyAnimalComp(image: animal.animalImage, species: animal.species, country: animal.country, ocean: animal.ocean, isoCode: animal.isoCode, color: animal.species == "Lion" || animal.species == "Elephant" ? "CustomBrownLight" : animal.species == "Polar Bear" || animal.species == "Penguin" || animal.species == "Shark" ? "CustomBlueLighter" : animal.species == "Sea Turtle" ? "CustomGreenLighter" : "CustomGreenLighter", colorSecondary: animal.species == "Lion" || animal.species == "Elephant" ? "CustomBrown" : animal.species == "Polar Bear" || animal.species == "Penguin" || animal.species == "Shark" ? "CustomBlue" : animal.species == "Sea Turtle" ? "CustomGreen" : "CustomGreen")
